...
class UploadHandler:
    def __init__(self, db_helper):
        ...
        self.faceloading = Faceloading(r"D:\Python\CameraNavigation\CameraNavigationSummerPractic\resources\faces")
...
if __name__ == '__main__':
    ...
    for dir_ in os.listdir(r"D:\Python\CameraNavigation\CameraNavigationSummerPractic\resources\faces"):
        path = r"D:\Python\CameraNavigation\CameraNavigationSummerPractic\resources\faces\\" + dir_ + '\\'
