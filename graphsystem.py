...
class GraphSystem:
    ...
    def draw_location(fig, field, walls=None, cameras=None, selected_fields=None, exits=None):
        ...
        if walls is not None:
            GraphSystem.draw_walls(fig, walls)
        if cameras is not None:
            GraphSystem.draw_cameras(fig, cameras)
        if selected_fields is not None:
            GraphSystem.draw_selected_field(fig, selected_fields)
        if exits is not None:
            GraphSystem.draw_exits(fig, exits)
